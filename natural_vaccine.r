...
cmv_sim = function(input){
  ...
  gompertz <- function(time, a, mu, lambda){
    ...
    return(data.table(age=time, frac=y))
  }
...
for (k in 1:length(vacc_prob)){
  for (l in 1:length(age_vacc)){
    for (m in 1:length(booster_times)){
      input = rbind(input,cbind(pars,pars[,7],pars[,8],vacc_prob[k],age_vacc[l],booster_times[m]))
    }
  }
}
...
dir.create("/home/sgazea01/projects/def-craigm/sgazea01/LowSero1/combined_child_vaccine_1")
setwd("/home/sgazea01/projects/def-craigm/sgazea01/LowSero1")
...
for (i in 1:(count/600)){
  ...
  write.csv(all_mother,paste0("/home/sgazea01/projects/def-craigm/sgazea01/LowSero1/combined_child_vaccine_1/summarized_mother_combined",i,".csv"),row.names=FALSE)
  write.csv(all_reff,paste0("/home/sgazea01/projects/def-craigm/sgazea01/LowSero1/combined_child_vaccine_1/Reff_combined",i,".csv"),row.names=FALSE)
  write.csv(all_children,paste0("/home/sgazea01/projects/def-craigm/sgazea01/LowSero1/combined_child_vaccine_1/children_combined",i,".csv"),row.names=FALSE)
}

file.copy("natural_vaccine.r", paste0("/home/sgazea01/projects/def-craigm/sgazea01/LowSero1/combined_child_vaccine_1"), overwrite = TRUE )
file.copy("vaccine_cluster.sh", paste0("/home/sgazea01/projects/def-craigm/sgazea01/LowSero1/combined_child_vaccine_1"), overwrite = TRUE )
